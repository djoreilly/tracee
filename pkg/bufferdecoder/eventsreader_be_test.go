...
func TestReadArgFromBuff(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			name: "modeT",
			input: []byte{0,
				0x0, 0x0, 0x11, 0xB6, // 0x000011B6 == 010666 == S_IFIFO|S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP|S_IROTH|S_IWOTH
			},
