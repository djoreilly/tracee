...
func NewDefaultProbeGroup(module *bpf.Module, netEnabled bool) (*ProbeGroup, error) {
	...
	allProbes := map[Handle]Probe{
		...
		ExecuteFinishedS390:         NewTraceProbe(KretProbe, "__s390_sys_execve", "trace_execute_finished"),
		ExecuteAtFinishedS390:       NewTraceProbe(KretProbe, "__s390_sys_execveat", "trace_execute_finished"),
		ExecuteFinishedCompatS390:   NewTraceProbe(KretProbe, "__s390_compat_sys_execve", "trace_execute_finished"),
		ExecuteAtFinishedCompatS390: NewTraceProbe(KretProbe, "__s390_compat_sys_execveat", "trace_execute_finished"),
		ExecuteFinishedGeneric:     NewTraceProbe(KretProbe, "sys_execve", "trace_execute_finished"),
		ExecuteAtFinishedGeneric:   NewTraceProbe(KretProbe, "sys_execveat", "trace_execute_finished"),
		ExecuteFinishedCompatGeneric: NewTraceProbe(KretProbe, "compat_sys_execve", "trace_execute_finished"),
		ExecuteAtFinishedCompatGeneric: NewTraceProbe(KretProbe, "compat_sys_execveat", "trace_execute_finished"),
